    ...
    <br/><br>
      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="edan-search-description">The title used in breadcrumbs and menu.</div>
        </div>
      </fieldset>
      <br/><hr><br/><br/>
      <fieldset>
        <legend class="edan-search-header"><strong>Search Configuration:</strong></legend><br/>
          ...
          <div class="edan-search-description">The message that's shown when a search returns results. Tokens for @count (number of items)</div>
        </div>
        <br/>
        ...
        <div>
          ...
          <div class="edan-search-description">A number between 1 and 100.</div>
        </div>
      </fieldset>
      <br/><hr><br/><br/>
      <fieldset>
        ...
        <div>
          ...
          <div class="edan-search-description">You can modify the message that gets displayed above the list of currently selected facets.</div>
        </div>
        <br/>
        ...
        <div>
          ...
          <div class="edan-search-description">Use this box to indicate any facets which should be hidden. Enter one facet per line, and enter only the facet name such as "data_source" without the quotes.</div>
        </div>
      </fieldset>
      <br/><hr><br/><br/>
      <fieldset>
        ...
        <div>
          ...
          <div class="edan-search-description">Metadata to show in search results. Each field should be on its own line. Leave blank to hide all field, or * to show all fields. If you want to specify a set of fields and then show the remaining add an * as the last line. Examples of topics: creditLine dataSource objectType.</div>
        </div>
        <br/>
        ...
        <div>
          ...
          <div class="edan-search-description">Fields listed here will be marked with the mini class. By default this will cause non-mini fields to be hidden and add a "expand" button to each record to show non-mini fields. Each field should be on its own line. Leave blank for all.</div>
        </div>
        <br/>
      </fieldset>
      <br/><hr>
